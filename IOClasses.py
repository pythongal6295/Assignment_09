...
# KKauffman, 2020-Sept-09, Added to save_inventory and load_inventory functions
#------------------------------------------#
    ...
    def load_inventory(file_name: list) -> list:
        ...
        try:
            with open(file_name_cd, 'r') as file:
                ...
                file.close()
            # TO Done add code to load track data
        ...
        #If function can't find the file, then this code will execute
            print('\nCD and Track Inventory files do not yet exist. Creating new files now.\n')
