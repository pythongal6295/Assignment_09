...
# KKauffman, 2020-Sept-09, Added sub menu for track info
#------------------------------------------#
...
while True:
    ...
    if strChoice == 'l':
        ...
        # TO Done add code to handle tracks on an individual CD
        while True:
            ...
            if strChoice == 'a':
                ...
                IO.ScreenIO.show_tracks(cd)
                trk_idx = input ('\nSelect the index of tracks you would like to remove.')
