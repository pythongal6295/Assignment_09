...
# KKauffman, 2020-Sept-08, added to Track class
# KKauffman, 2020-Sept-09, added to add_track and rmv_track
#------------------------------------------#
...
class Track():
    ...
    def position (self, new_position):
        if type(new_position) == int:
            if new_position < 1:
                raise Exception ('/nTrack position cannot be less than 1.')
            self.__position = new_position
        else:
            raise Exception ('/nTrack position needs to be an integer.')
    ...
    def title (self, new_title):
        if type(new_title) == str:
            self.__length = new_title
        else:
            raise Exception('\nTrack title needs to be a string.')
    ...
    def length(self, new_length):
        if type(new_length) == str:
            ...
            raise Exception('\nTrack length needs to be a string.')
    
    # -- Methods -- #
    # TO Done Add Track class methods
    def __str__(self):
